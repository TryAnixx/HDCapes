...
public class RequestAPI {
    ...
    private static void addToCapeDatabase() {
        exservice.execute(() -> {
            try {
                HttpURLConnection con = (HttpURLConnection) (new URL(
                        "http://tryanixxaddons.de.cool/hdcapes/data.php?name=" + LabyMod.getInstance().getLabyModAPI().getPlayerUsername() + "&uuid=" + LabyMod.getInstance().getLabyModAPI().getPlayerUUID())).openConnection();
